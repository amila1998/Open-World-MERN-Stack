...
router.post('/', async (req, res) => {
  ...
  try {
    ...
    await EmailService.sendMessage(
      guideEmail,
      `<h1>You Have New Booking Request</h1><br/>
      <h2>Requested User Name: ${userdata?.name}</h2><br/>
      <h2>Requested Start Date: ${newBookingData?.startdate}</h2><br/>
      <h2>Requested End Date: ${newBookingData?.enddate}</h2><br/>
      <br/><a href="http://localhost:3000/booking/${newBookingData?._id}">Click Here to Confirm Booking</a>`,
