                            ...
                            <main>
                                <div className="row center">
                                      ...
                                      {this.state.destinations.map((destinations,index)=>(
                                        ...
                                        <img className="destination-medium" src={ "http://localhost:8070/" + destinations.image1 } alt="gjgjgj"/>
                                        </a>
                                        <div className="destination-card-body">
                                            <a href={`/Destination/${destinations._id}`}>
                                                <h6 id = "destitle"><center>{destinations.title}</center></h6>
                                                <center><a href={`/Destination/${destinations._id}`} class="btn btn-primary" id= "deshoombtn"><h3>View</h3></a></center>
                                            </a>
                                        </div>
                                    </div>                                            
                                    ))
