...
export default class EditVehicle extends Component {
    ...
    onSubmit = (e) =>{
        ...
        if(this.state.name && this.state.brand && this.state.price_per_day  && this.state.image1  && this.state.image2 && this.state.image3 && this.state.image4 && this.state.image5 && this.state.year && this.state.category  && this.state.seat_capacity  && this.state.description && this.state.contact_number ){
            ...
            axios.put(`http://localhost:8070/vehicle/update/${id}`,data).then((res)=>{
    ...
    componentDidMount(){
        ...
        axios.get(`http://localhost:8070/vehicle/${id}`).then((res)=>{
            if(res.data.success){
                this.setState({
                    is_booked:res.data.vehicle.is_booked,
                    name:res.data.vehicle.name,
                    brand:res.data.vehicle.brand,
                    price_per_day:res.data.vehicle.price_per_day,
                    image1:res.data.vehicle.image1,
                    image2:res.data.vehicle.image2,
                    image3:res.data.vehicle.image3,
                    image4:res.data.vehicle.image4,
                    image5:res.data.vehicle.image5,
                    year:res.data.vehicle.year,
                    category:res.data.vehicle.category,
                    seat_capacity:res.data.vehicle.seat_capacity,
                    description:res.data.vehicle.description,
                    contact_number:res.data.vehicle.contact_number,
                });
