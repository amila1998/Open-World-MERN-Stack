...
class Booking extends React.Component {
    ...
    onChange(id){
        ...
        axios.get(url).then(response => this.setState({customer_name:response['data']['customer_name'], contactnumber:response['data']['contactnumber']  ,email:response['data']['email'],numberofvisitors:response['data']['numberofvisitors'],Booking_Date:response['data']['Booking_Date'],id:id}))
                    ...
                    <table class="table">
                        <thead>
                            <tr>
                                ...
                                <th class="tableTh">Customer Name</th>
                                <th class="tableTh">Contact Number</th>
                                <th class="tableTh">Email</th>
                                <th class="tableTh">Number of Visitors</th>
                                <th class="tableTh">Booking Date</th>
                        ...
                        <tbody>
                        {
                            ...
                            <tr>
                                ...
                                <td class="tableTh">{ res.customer_name }</td>
                                <td class="tableTh">{ res.contactnumber }</td>
                                <td class="tableTh">{ res.email }</td>
                                <td class="tableTh">{ res.numberofvisitors }</td>
                                <td class="tableTh">{ res.Booking_Date }</td>
