...
export const ROOM_DETAILSWITHDAYS_REQUEST = 'ROOM_DETAILSWITHDAYS_REQUEST';
export const ROOM_DETAILSWITHDAYS_SUCCESS = 'ROOM_DETAILSWITHDAYS_SUCCESS';
export const ROOM_DETAILSWITHDAYS_FAIL = 'ROOM_DETAILSWITHDAYS_FAIL';