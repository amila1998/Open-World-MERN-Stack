...
export const HOTEL_LISTFORHSP_REQUEST = 'HOTEL_LISTFORHSP_REQUEST';
export const HOTEL_LISTFORHSP_SUCCESS = 'HOTEL_LISTFORHSP_SUCCESS';
export const HOTEL_LISTFORHSP_FAIL = 'HOTEL_LISTFORHSP_FAIL';
